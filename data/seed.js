...
function buildLanguages() {
  const t = {
    en: {
      ...
      instapay_proof_title:'Payment screenshot / proof', instapay_proof_hint:'After you complete the transfer, upload a screenshot of the InstaPay confirmation.', instapay_proof_choose:'Choose payment screenshot', instapay_proof_selected:'Selected: {name}', instapay_proof_missing:'Please upload your InstaPay payment screenshot before placing the order.', instapay_proof_invalid:'Please choose a valid image file.', instapay_proof_too_large:'This image is too large. Please choose an image up to 6 MB.', instapay_proof_read_error:'We could not read that image. Please choose it again.', instapay_proof_upload_error:'We could not save your payment screenshot. Please try again.',
    ...
    ar: {
      ...
      instapay_proof_title:'إثبات الدفع عبر إنستاباي', instapay_proof_hint:'بعد إتمام التحويل، ارفع لقطة شاشة لتأكيد عملية إنستاباي.', instapay_proof_choose:'اختر لقطة الدفع', instapay_proof_selected:'تم اختيار: {name}', instapay_proof_missing:'يرجى رفع لقطة شاشة لتحويل إنستاباي قبل تأكيد الطلب.', instapay_proof_invalid:'يرجى اختيار ملف صورة صالح.', instapay_proof_too_large:'الصورة كبيرة جدًا. اختر صورة بحجم يصل إلى 6 ميجابايت.', instapay_proof_read_error:'تعذر قراءة الصورة. يرجى اختيارها مرة أخرى.', instapay_proof_upload_error:'تعذر حفظ لقطة الدفع. يرجى المحاولة مرة أخرى.',
